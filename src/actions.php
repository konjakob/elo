...
if (isset($_GET['action']) || isset($_POST['action'])) {
    ...
    if ($action == 'getUser') {
        ...
        $statement = $pdo->prepare("select user_id, user_name, user_email, lang_id from elo_user where user_id=:userid");
        $statement->bindValue(':userid', filter_input(INPUT_GET, 'userid', FILTER_SANITIZE_NUMBER_INT));
        $statement->execute();
        ...
        if (isset($_POST['userid']) && isset($_POST['t_name']) && isset($_POST['t_email']) && isset($_POST['t_lang'])) {
